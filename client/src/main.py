...
def init_bokeh(out_dir: str, img_dir: str) -> Any:
    ...
    return plot, map_info, trans_scale
...
def init_env(
    ...
    plot, map_info, trans_scale = init_bokeh(out_dir, img_dir)
...
if __name__ == "__main__":
    ...
    data = init_env(topic, address, port, out_dir, img_dir)
